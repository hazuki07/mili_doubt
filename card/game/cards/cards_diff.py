...
# ***********************************************************
#  Suit & Number & Joker Enum property
#  https://smooth-pudding.hatenablog.com/entry/2021/05/30/000848
# ***********************************************************
...
class Suit(Enum):
    ...
    D = SuitProperty(str="♢", value=1, is_black=False)
    C = SuitProperty(str="♣", value=2, is_black=True)
    H = SuitProperty(str="♡", value=3, is_black=False)

    def __str__(self):
        return self.value.str
# str、format、printを呼び出すメソッド
